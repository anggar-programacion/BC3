...
def leer_registros_P(archivo_bc3):
    registros_P = {}  # Diccionario para almacenar los registros P
        ...
        for linea in f:
            ...
            if linea_decodificada.startswith('~P'):  # Verificar si la línea comienza con "~P"
                ...
                if len(campos) >= 1:
                    ...
                    # Almacenar el registro P en una lista dentro del diccionario
    ...
    # Guardar cada registro P en un archivo individual en el directorio creado
...
def main():
    ...
    if archivo_bc3:
        leer_registros_P(archivo_bc3)
        print("Los parámetros se han guardado en el directorio 'Parametros'.")
    else:
